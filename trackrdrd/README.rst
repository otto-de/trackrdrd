...
have been compiled. Varnish sources with features added for Lhotse are
in::
...
variable ``VARNISHSRC``::
	...
	$ ./autogen.sh
	$ CXXFLAGS=-m64 CFLAGS=-m64 ./configure VARNISHSRC=/path/to/lhotse-varnish-cache
	$ make
...
``--prefix`` option::
	...
	$ CFLAGS=-m64 CXXFLAGS=-m64 ./configure VARNISHSRC=/path/to/lhotse-varnish-cache \\
